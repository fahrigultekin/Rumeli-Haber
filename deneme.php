...
<div class="container" style="width: 60%;">
    <h1><?php echo htmlspecialchars($row['haber_baslik']); ?></h1><br>
    <h3><?php echo htmlspecialchars($row['haber_aciklama']); ?></h3><br>
    <img class="img-responsive" src="<?php echo htmlspecialchars($row['haber_img']); ?>" alt=""><br>
    <p><?php echo nl2br(htmlspecialchars($row['haber_metin'])); ?></p>
    <p>Okunma Sayısı: <?php echo htmlspecialchars($row['haber_okunmasayisi']); ?></p>
</div>
