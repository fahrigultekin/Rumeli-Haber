    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <?php
                ...
                $habercek = $db->prepare("SELECT * FROM haberler WHERE haber_kategori='sondakika' LIMIT 8");
                $habercek->execute();
        ...
        <div class="row">
            ...
            <?php
                $okunanHabercek = $db->prepare("SELECT * FROM haberler WHERE haber_kategori='sondakika' ORDER BY haber_okunmasayisi DESC LIMIT 8");
        ...
        <div class="row">
            ...
            <?php
                $okunanHabercek = $db->prepare("SELECT * FROM haberler WHERE haber_kategori='sondakika' ");
                $okunanHabercek->execute();
