  ...
  <div class="container mt-5">
        ...
        <div class="row">
            ...
            <?php
                ...
                $habercek = $db->prepare("SELECT * FROM haberler WHERE haber_kategori='teknoloji' LIMIT 8");
                $habercek->execute();
        ...
        <div class="row">
            ...
            <?php
                $okunanHabercek = $db->prepare("SELECT * FROM haberler WHERE haber_kategori='teknoloji' ORDER BY haber_okunmasayisi DESC LIMIT 8");
        ...
        <div class="row">
            ...
            <?php
                $okunanHabercek = $db->prepare("SELECT * FROM haberler WHERE haber_kategori='teknoloji' ");
                $okunanHabercek->execute();
